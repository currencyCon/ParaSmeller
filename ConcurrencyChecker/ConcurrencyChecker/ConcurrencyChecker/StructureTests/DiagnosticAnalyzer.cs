...
namespace ConcurrencyChecker.StructureTests
{
    [DiagnosticAnalyzer(LanguageNames.CSharp)]
    public class ConcurrencyCheckerAnalyzer : DiagnosticAnalyzer
    {
        public const string DiagnosticId = "ConcurrencyChecker";
