...
{
    public class SynchronizedPropertyRepresentation : IPropertyRepresentation
    {
        ...
        public SynchronizedPropertyRepresentation(PropertyDeclarationSyntax propertyDeclarationSyntax, ClassRepresentation classRepresentation)
        {
